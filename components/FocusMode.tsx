...
export default function FocusMode({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[70] flex items-end md:items-center justify-center p-0 md:p-4">
      <div className="bg-white dark:bg-slate-900 rounded-t-[2.5rem] md:rounded-[2rem] shadow-2xl max-w-2xl w-full px-6 pt-6 pb-24 md:p-8 pb-safe relative border border-gray-200 dark:border-slate-800 max-h-[90vh] overflow-y-auto animate-slide-up md:animate-spring-in">
        {/* Bouton fermer */}
        <button
          onClick={onClose}
        ...
        {notification && (
          <div
            className={`mb-6 p-4 rounded-lg text-sm font-medium animate-slide-in-right ${notification.type === "success"
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold mb-2 text-gray-900 dark:text-white">
            {isWorkSession ? <Zap className="inline-block text-yellow-400 mr-2" /> : <Coffee className="inline-block text-blue-400 mr-2" />}
          ...
          <div className="relative w-64 h-64">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="text-4xl sm:text-5xl font-bold mb-2 text-gray-900 dark:text-white">{formatTime(timeLeft)}</div>
        ...
        <div className="flex gap-4 justify-center mb-6">
          <button
            onClick={toggleTimer}
            className={`px-8 py-3 rounded-xl font-semibold text-white transition shadow-md ${isWorkSession
        ...
        <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          <Lightbulb size={16} className="inline-block text-yellow-400 mr-2" /> Astuce : Garde ton téléphone loin pendant la session
        </div>
      </div>
    </div>
  );
