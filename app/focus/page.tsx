...
export default function FocusPage() {
  ...
  const handleSessionComplete = async () => {
    // Recharger les statistiques après une session
    await loadData();
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {!showTimer ? (
            <>
              {/* Header */}
              <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900">🔥 Mode Focus</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-3xl font-bold text-primary">{formatTime(todayTime)}</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                  <p className="text-sm text-gray-600 mb-1">Sessions Focus</p>
              ...
              {/* Démarrage rapide */}
              <div className="bg-gradient-to-r from-primary to-blue-600 text-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <button
                  ...
                  className="bg-white text-primary px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition text-lg"
                >
